...
directories from earlier verification rounds remain committed for
...
- `discovery_open_subaccount_20260816T063050Z/`,
  ...
  `discovery_open_subaccount_20260816T181601Z/`,
  `discovery_open_subaccount_20260818T024824Z/`,
  `discovery_open_subaccount_20260818T034109Z/`,
  `discovery_open_subaccount_20260818T172251Z/` — earlier discovery runs.
  Superseded by `discovery_open_subaccount_20260818T173007Z/` (item 1)
  which uses `gpt-5` and a natural-language goal.

## Note on stray `demo123` occurrences

A grep of the entire `evidence/` tree for `demo123` returns hits only
inside `discovery_open_subaccount_20260818T173007Z/{transcript,evidence}.json`.
